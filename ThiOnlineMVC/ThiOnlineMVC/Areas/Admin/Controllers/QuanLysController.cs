...
namespace ThiOnlineMVC.Areas.Admin.Controllers
{
    public class QuanLysController : Controller
    {
        ...
        {
            var nguoiDungs = db.NguoiDungs.Where(n => n.IDVaiTro == 3);
            return View(nguoiDungs.ToList());
        }

        // GET: Admin/QuanLys/Details/5
