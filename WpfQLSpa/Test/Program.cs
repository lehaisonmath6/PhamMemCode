...
namespace Test
{
    class Program
    {
        ...
        public static void SendJson(string phone, string message)
        {

            string APIKey = "BAA626FCB4BC94F6AE3AFF78FFBE03";
            string SecretKey = "3D73A5D0170C33C87F8BD0D9BDF713";
            //Sample Request
        ...
        {
            SendJson("0384399862", "Xin chao ban");
        }
    }
}
